...
export default function NavbarPress() {
  return (
    <>
      <section className="bg-gradient-to-r from-[#3178CA] via-[#0976F790] to-[#a3c9f5] py-2 px-4 flex justify-between items-center text-2xl h-16 text-white">
        <Link href="/">Home</Link>
        <div className="flex justify-between items-center gap-8">
          <Link className="first-letter:uppercase" href="press-agency/about">
            about
          </Link>
